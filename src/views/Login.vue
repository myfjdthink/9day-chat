<template>
  <div class="flex-1 p-8 bg-gray-50 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md mx-auto bg-white rounded-xl shadow-lg p-8">
      <div class="text-center mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-900 mb-2">用户登录</h2>
        <p class="text-gray-500">欢迎回来，请输入您的账号信息</p>
      </div>
      ...
      <div class="flex justify-between mt-4 text-sm">
        <router-link to="/forgot-password" class="text-blue-500 hover:underline">忘记密码？</router-link>
        <router-link to="/register" class="text-gray-500 hover:underline">注册新账号</router-link>
      </div>
    </div>
  </div>
</template>
